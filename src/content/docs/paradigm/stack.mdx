---
title: Stack
description: boldandbrad technology stack.
---

At the rate that new frameworks, technologies, and design patterns are created,
it is impossible and also nonsensical to maintain a static tech stack. However, in an
effort to create some semblance of consistency and to prevent endless context
...
- Astro - flexible frontend framework
